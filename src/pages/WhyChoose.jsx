  ...
  return (  
    <>
      <Helmet>
        {/* Title */}
        <title>
          Expertise & Services | Own with Clarity & Grow with Confidence – OWNiFiE
        </title>

        {/* Meta Description */}
        <meta
          name="description"
          content="OWNiFiE offers a secure, digital dashboard to track ownership shares, rental returns, property appreciation, and investment documents — all in real time"
        />

        {/* Canonical URL to prevent Duplicate Content */}
        <link rel="canonical" href="https://ownifie.com/why-choose" />
        ...
        <meta
          property="og:url"
          content="https://ownifie.com/why-choose"
        />
        <meta
          property="og:title"
          content="Expertise & Services | Own with Clarity & Grow with Confidence – OWNiFiE"
        />
        <meta
      ...
      <div className="w-full space-y-10 bg-gradient-to-br from-[#a0a993] via-white to-slate-100">
          ...
          <div className="flex flex-col justify-center items-center gap-x-3 gap-y-8">
            <div className="w-full flex flex-col md:flex-row justify-center items-center gap-x-8">
              <div
                ...
                className="w-full xs:w-[85%] md:w-[50%] flex justify-center md:justify-end"
              >
                <img
                  src={multimodelImage}
                  loading="lazy"
              ...
              <div
                ...
                className="w-full xs:w-[65%] md:w-[50%]"
              >
                <p className="text-center md:w-[100%] lg:w-[90%] xl:w-[70%] text-lg">
                  From Sole Ownership to Fractional and Co-Ownership,{" "}
                  <span className="font-semibold">OWNiFiE </span>
                  offers structured models tailored to every budget and
                  investment strategy.
                </p>
              </div>
            </div>
            ...
            <div className="w-full flex flex-col md:flex-row justify-center items-center  gap-x-8">
              <div
                data-aos="zoom-in-left"
                className="w-full xs:w-[65%] md:w-[50%] flex justify-end order-2 md:order-1"
              >
                <p className="text-center md:w-[100%] lg:w-[90%] xl:w-[70%] text-lg">
              ...
              <div
                data-aos="zoom-in-right"
                className="w-full xs:w-[85%] md:w-[50%] flex justify-center md:justify-start order-1 md:order-2"
              >
                <img
                  src={techDrivenImage}
                  loading="lazy"
            ...
            <div className="w-full flex flex-col md:flex-row justify-center items-center gap-x-8">
              ...
              >
                <p className="text-center md:w-[100%] lg:w-[90%] xl:w-[70%] text-lg">
                  ...
                  personal use (in select co-ownership models) — blending
                  passive income with lifestyle benefits.
                </p>
              </div>
            ...
            <div className="w-full flex flex-col md:flex-row justify-center items-center gap-x-8">
              ...
              >
                <p className="text-center md:w-[100%] lg:w-[90%] xl:w-[70%] text-lg">
                  Every deal is built on RERA-compliant, titlesecured
                  frameworks, supported by proper agreements, due diligence, and
            ...
            <div className="w-full flex flex-col md:flex-row justify-center items-center  gap-x-8">
              ...
              >
                <p className="text-center md:w-[100%] lg:w-[90%] xl:w-[70%] text-lg">
                  ...
                  for location, legal soundness, ROI potential, and alignment
                  with modern investor goals.
                </p>
              </div>
            ...
            <div className="w-full flex flex-col md:flex-row justify-center items-center gap-x-8">
              ...
              >
                <p className="text-center md:w-[100%] lg:w-[90%] xl:w-[70%] text-lg">
                  No hassles — <span className="font-semibold">OWNiFiE</span>{" "}
                  handles maintenance, tenancy, documentation, taxation, and
                  even exit support, so you focus on wealth, not paperwork.
                </p>
              </div>
            </div>
          </div>
        ...
        <section data-aos="zoom-in-up" className="px-6 sm:px-16">
          <p className="text-lg text-gray-700 max-w-3xl mx-auto text-center leading-relaxed">
            ...
            <span className="font-semibold">OWNiFiE</span> is a gateway to
            fractional and co-ownership of premium real estate — villas on
            mountain ridges, serene farmlands, stylish city apartments, and
            eco-retreats — all verified, transparent, and accessible from your
            fingertips.
          </p>
        </section>
