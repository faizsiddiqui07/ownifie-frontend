  ...
  return (
    <>
      <Helmet>
        {/* Title */}
        <title>
          Business Model | Fractional & Tokenized Real Estate Platform - OWNiFiE
        </title>

        {/* Meta Description */}
        <meta
          name="description"
          content="Explore OWNiFiE’s business model: fractional ownership, co-ownership, sole ownership & tokenized real estate & asset investment platform"
        />

        {/* Canonical URL to prevent Duplicate Content */}
        <link rel="canonical" href="https://ownifie.com/business-model" />

        {/* Keywords */}
        <meta
          name="keywords"
          content="OWNiFiE, business model, fractional ownership, tokenized real estate, co-ownership investment, property tokenization, real estate blockchain platform, sustainable real estate investment, portfolio management, OWNiFiE BIT"
        />

        {/* Open Graph Metadata */}
        <meta property="og:url" content="https://ownifie.com/business-model" />
        <meta
          property="og:title"
          content="Business Model | Fractional & Tokenized Real Estate Platform - OWNiFiE"
        />
        <meta
            ...
            <div data-aos="zoom-in-left" className="space-y-6">
              ...
              <div className="">
                ...
                <p className="text-gray-700">
                  ...
                  residential, commercial, agricultural, or farmland. The title
                  is registered solely in the investor's name, offering complete
            ...
            >
              ...
              <div className="">
                ...
                <p className="text-gray-700">
                  ...
                  shares of a high-value property, dividing capital investment
                  and ownership rights. Income, appreciation, and resale value
                  are distributed proportionally. <br />
