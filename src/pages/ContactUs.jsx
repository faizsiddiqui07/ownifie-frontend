  ...
  return (
    <>
      <Helmet>
        {/* Title */}
        <title>
          Contact Us | Get in Touch for Investment Opportunities - OWNiFiE
        </title>

        {/* Meta Description */}
        <meta
          name="description"
          content="Connect with OWNiFiE for fractional real estate ownership, co-ownership investments, and tokenized property opportunities"
        />

        {/* Canonical URL to prevent Duplicate Content */}
        <link rel="canonical" href="https://ownifie.com/contact-us" />

        {/* Keywords */}
        <meta
          name="keywords"
          content="OWNiFiE contact, real estate investment contact, fractional ownership support, co-ownership inquiries, tokenized property contact, OWNiFiE customer support, OWNiFiE office"
        />

        {/* Open Graph Metadata */}
        <meta property="og:url" content="https://ownifie.com/contact-us" />
        <meta
          property="og:title"
          content="Contact Us | Get in Touch for Investment Opportunities - OWNiFiE"
        />
        <meta
        ...
        <section className="px-4 sm:px-16 py-12">
          <div data-aos="zoom-in" className="text-center space-y-4">
            ...
            <p className="text-lg text-gray-600 max-w-xl mx-auto">
              Explore our Mission, our Principles and the Passion behind what we
              do
            </p>
          </div>
        </section>
        ...
        <section className="px-4 sm:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div data-aos="zoom-in-right" className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Your journey starts here. Get in touch with our team to learn
                  more—we’re just a message away.
                </p>
              </div>
            ...
            <div
              ...
              className="p-8 bg-white shadow-xl rounded-xl border border-gray-100"
            >
