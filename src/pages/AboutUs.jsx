  ...
  return (
    <>
      <Helmet>
        {/* Title */}
        <title>
          About Us | Redefining Real Estate Investment with Fractional & Tokenized-Ownership – OWNiFiE
        </title>

        {/* Meta Description */}
        <meta
          name="description"
          content="OWNiFiE is a real estate investment platform enabling fractional ownership, co-ownership & tokenized-ownership of properties & assets"
        />

        {/* Canonical URL to prevent Duplicate Content */}
        <link rel="canonical" href="https://ownifie.com/about-us" />

        {/* Keywords */}
        <meta
          name="keywords"
          content="OWNiFiE, about OWNiFiE, real estate investment platform, fractional ownership, co-ownership, tokenized property, holiday home investment, eco-tech real estate, Magnecron, Buildifie"
        />

        {/* Open Graph Metadata */}
        <meta property="og:url" content="https://ownifie.com/about-us" />
        <meta
          property="og:title"
          content="About Us | Redefining Real Estate Investment with Fractional & Tokenized-Ownership – OWNiFiE"
        />
        <meta
        ...
        <section className="px-6 sm:px-16 py-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-4 text-center">
            <p data-aos="zoom-in" className="text-gray-700">
              ...
              <span className="text-black font-semibold">BUILDIFIE</span>,
              India's pioneering EcoTech Realty venture.{" "}
              ...
              estate assets across residential, commercial, agricultural, and
              farm property segments-through both complete ownership and
              innovative shared ownership models.
            </p>
            <p data-aos="zoom-in" className="text-gray-700">
              ...
              lucrative assets-accessible to anyone, from first-time investors
              to seasoned wealth builders.
            </p>

            <p data-aos="zoom-in" className="text-[#972608] font-semibold">
              <span className="text-[#122F6B]">OWNiFiE</span> isn't a real
              estate or proptech company. <br />
            ...
            <p data-aos="zoom-in" className="text-gray-700">
              We're not just selling land or homes - we're offering a smarter
              way to own the world, fraction by fraction, foundation by
              foundation.
              <br />
              <span className="text-black font-semibold">OWNiFiE</span> is a
        ...
        <section className="space-y-8 mb-12 pb-8 px-6 sm:px-16 cursor-default">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div
              ...
              className="p-6 border border-[#d08e02] rounded-lg text-center shadow-md hover:shadow-lg"
            >
            ...
            >
              ...
              <p className="text-gray-600 mt-2">
                Creativity fuels us. Progress drives us. We innovate to lead,
                not follow.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="text-gray-600 mt-2">
                We don’t settle for average — we craft excellence into
                everything we do.
              </p>
            </div>
          </div>
