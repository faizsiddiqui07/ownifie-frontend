    ...
    <div className="w-full space-y-10 bg-gradient-to-br from-[#a0a993] via-white to-slate-100">
      ...
      <div className="flex justify-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-6 sm:px-16 pb-10">
          {/* Block */}
          <div data-aos="zoom-in-right" className="bg-[#9eb0c137] w-full max-w-[550px] rounded-lg shadow-md p-6 space-y-4">
            <img
              src={problemWeSolve}
              loading="lazy"
            ...
            <p className="text-sm text-gray-700">
              ...
              barriers through tech-enabled, fractional and co-ownership models,
              allowing anyone to invest in curated, high-value properties
              securely and affordably.
            </p>
          </div>

          <div data-aos="zoom-in-left" className="bg-[#e9d1874c] w-full max-w-[550px] rounded-lg shadow-md p-6 space-y-4">
            <img
              src={whoWeServe}
              loading="lazy"
              alt="Who We Serve"
            ...
            <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
              ...
              <li>
                Tech-savvy millennials who want flexibility and control through
                a digital platform
              </li>
            </ul>
          </div>

          <div data-aos="zoom-in-right" className="bg-[#3ebd2d2f] w-full max-w-[550px] rounded-lg shadow-md p-6 space-y-4">
            <img
              src={howWeWork}
              loading="lazy"
              alt="How We Work"
            ...
            <p className="text-sm text-gray-700">
              OWNiFiE makes investing easy through a streamlined 5-step process:
            </p>
            <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
          ...
          <div data-aos="zoom-in-left" className="bg-[#bfb6bf4f] w-full max-w-[550px] rounded-lg shadow-md p-6 space-y-4">
            <img
            ...
            <p className="text-sm text-gray-700">
              <span className="font-semibold">OWNiFiE</span> connects investors
          ...
          <div data-aos="zoom-in-right" className="bg-[#e98b2146] w-full max-w-[550px] rounded-lg shadow-md p-6 space-y-4">
            <img
          ...
          <div data-aos="zoom-in-left" className="bg-[#d9d9d951] w-full max-w-[550px] rounded-lg shadow-md p-6 space-y-4">
            <img
              src={teamBehind}
              loading="lazy"
              alt="Team Behind"
            ...
            <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
              <li>
                Founders – Background in architecture, real estate & technology
              </li>
              <li>
                Legal & Compliance Experts – Ensuring all models are
                RERA/SEBI-compliant
              </li>
              <li>Tech Architects – Building secure and scalable platforms</li>
              <li>
